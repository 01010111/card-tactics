...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		openfl.text.Font.registerFont (__ASSET__OPENFL__fonts_nunito_black_ttf);
		openfl.text.Font.registerFont (__ASSET__OPENFL__fonts_oduda_bold_ttf);
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__images_ui_ap_pips_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__images_ui_ap_pip_big_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__images_ui_mutant_card_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__images_ui_shield_icon_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__data_gear_jsonc extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__data_translations_gameplay_jsonc extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__data_translations_gear_titles_jsonc extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__fonts_nunito_black_ttf extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__fonts_oduda_bold_ttf extends null { }
...
@:keep @:image("assets/images/ui/ap_pips.png") @:noCompletion #if display private #end class __ASSET__images_ui_ap_pips_png extends lime.graphics.Image {}
@:keep @:image("assets/images/ui/ap_pip_big.png") @:noCompletion #if display private #end class __ASSET__images_ui_ap_pip_big_png extends lime.graphics.Image {}
...
@:keep @:image("assets/images/ui/mutant_card.png") @:noCompletion #if display private #end class __ASSET__images_ui_mutant_card_png extends lime.graphics.Image {}
...
@:keep @:image("assets/images/ui/shield_icon.png") @:noCompletion #if display private #end class __ASSET__images_ui_shield_icon_png extends lime.graphics.Image {}
...
@:keep @:file("assets/data/gear.jsonc") @:noCompletion #if display private #end class __ASSET__data_gear_jsonc extends haxe.io.Bytes {}
...
@:keep @:file("assets/data/translations/gameplay.jsonc") @:noCompletion #if display private #end class __ASSET__data_translations_gameplay_jsonc extends haxe.io.Bytes {}
@:keep @:file("assets/data/translations/gear_titles.jsonc") @:noCompletion #if display private #end class __ASSET__data_translations_gear_titles_jsonc extends haxe.io.Bytes {}
@:keep @:font("export/html5/obj/webfont/nunito_black.ttf") @:noCompletion #if display private #end class __ASSET__fonts_nunito_black_ttf extends lime.text.Font {}
@:keep @:font("export/html5/obj/webfont/oduda_bold.ttf") @:noCompletion #if display private #end class __ASSET__fonts_oduda_bold_ttf extends lime.text.Font {}
...
@:keep @:expose('__ASSET__fonts_nunito_black_ttf') @:noCompletion #if display private #end class __ASSET__fonts_nunito_black_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "fonts/nunito_black"; #else ascender = 1011; descender = -353; height = 1364; numGlyphs = 1039; underlinePosition = -100; underlineThickness = 50; unitsPerEM = 1000; #end name = "Nunito Black"; super (); }}
@:keep @:expose('__ASSET__fonts_oduda_bold_ttf') @:noCompletion #if display private #end class __ASSET__fonts_oduda_bold_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "fonts/oduda_bold"; #else ascender = 1010; descender = -190; height = 1200; numGlyphs = 147; underlinePosition = -100; underlineThickness = 50; unitsPerEM = 1000; #end name = "Oduda Bold"; super (); }}
...
#if html5
@:keep @:expose('__ASSET__OPENFL__fonts_nunito_black_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__fonts_nunito_black_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__fonts_nunito_black_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__fonts_oduda_bold_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__fonts_oduda_bold_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__fonts_oduda_bold_ttf ()); super (); }}
